...
$checks = [
    ...
    [$calculator, "index.html?v=33408f70a67c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=33408f70a67c", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=33408f70a67c", 'App HTML must load the current stylesheet without stale asset cache'],
