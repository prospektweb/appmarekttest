...
$checks = [
    ...
    [$calculator, "index.html?v=85552a5cba31", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=85552a5cba31", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=85552a5cba31", 'App HTML must load the current stylesheet without stale asset cache'],
