...
$checks = [
    ...
    [$calculator, "index.html?v=dc23b6a0dd86", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=dc23b6a0dd86", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=dc23b6a0dd86", 'App HTML must load the current stylesheet without stale asset cache'],
