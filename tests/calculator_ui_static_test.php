...
$checks = [
    ...
    [$calculator, "index.html?v=400242a7eb3c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=400242a7eb3c", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=400242a7eb3c", 'App HTML must load the current stylesheet without stale asset cache'],
