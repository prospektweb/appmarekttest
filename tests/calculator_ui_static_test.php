...
$checks = [
    ...
    [$calculator, "index.html?v=8e3eb921885c", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=8e3eb921885c", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=8e3eb921885c", 'App HTML must load the current stylesheet without stale asset cache'],
