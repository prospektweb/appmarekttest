...
$checks = [
    ...
    [$calculator, "index.html?v=039f0c78af94", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=039f0c78af94", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=039f0c78af94", 'App HTML must load the current stylesheet without stale asset cache'],
