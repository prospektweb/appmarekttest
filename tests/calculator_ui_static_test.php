...
$checks = [
    ...
    [$calculator, "index.html?v=25b553d2498a", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=25b553d2498a", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=25b553d2498a", 'App HTML must load the current stylesheet without stale asset cache'],
