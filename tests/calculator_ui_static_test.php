...
$checks = [
    ...
    [$calculator, "index.html?v=b15fd44dd094", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=b15fd44dd094", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=b15fd44dd094", 'App HTML must load the current stylesheet without stale asset cache'],
