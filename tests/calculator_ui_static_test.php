...
$checks = [
    ...
    [$calculator, "index.html?v=0adec2e1752e", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=0adec2e1752e", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=0adec2e1752e", 'App HTML must load the current stylesheet without stale asset cache'],
