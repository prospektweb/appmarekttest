...
$checks = [
    ...
    [$calculator, "index.html?v=14cd2acd3daa", 'Embedded calculator must load the current frontend release without stale HTML cache'],
    ...
    [$appIndex, "assets/index.js?v=14cd2acd3daa", 'App HTML must load the current JavaScript bundle without stale asset cache'],
    [$appIndex, "assets/style.css?v=14cd2acd3daa", 'App HTML must load the current stylesheet without stale asset cache'],
