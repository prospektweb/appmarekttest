...
2. **USE_OPERATION_VARIANT** (Сорт. 200)
   - Название: "Активировать выбор варианта Операции"
   - Тип: Список
   - Варианты: "Да" (XML_ID = Y) / "Нет" (XML_ID = N)

3. **DEFAULT_OPERATION_VARIANT** (Сорт. 250)
   - Название: "Вариант операции по умолчанию"
...
5. **USE_MATERIAL_VARIANT** (Сорт. 400)
   - Название: "Активировать выбор варианта Материала"
   - Тип: Список
   - Варианты: "Да" (XML_ID = Y) / "Нет" (XML_ID = N)

6. **DEFAULT_MATERIAL_VARIANT** (Сорт. 450)
   - Название: "Вариант материала по умолчанию"
   - Тип: Привязка к элементу
...
9. **OTHER_OPTIONS** (Сорт. 600)
   - Название: "Прочие опции"
   - Тип: HTML/текст
...
- Автоматически связывает свойства DEFAULT_OPERATION_VARIANT, SUPPORTED_EQUIPMENT_LIST, DEFAULT_MATERIAL_VARIANT и REQUIRES_BEFORE с соответствующими инфоблоками
